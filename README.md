...
- [albertominetti/python-notebooks](https://github.com/albertominetti/python-notebooks) - Rolling returns in 5 years, using reference currency and distributions (4 days ago)
- [albertominetti/daily-leetcode-notifier](https://github.com/albertominetti/daily-leetcode-notifier) - Check LeetCode&#39;s daily challenge for your account and get Telegram alerts. Scriptable with python, no dependencies. (5 days ago)
- [albertominetti/simple-kpi](https://github.com/albertominetti/simple-kpi) -  (1 week ago)
- [joaompinto/janito](https://github.com/joaompinto/janito) - Minimalistic LLM Client (2 weeks ago)
- [albertominetti/telegram-print-bot](https://github.com/albertominetti/telegram-print-bot) - Telegram bot that prints via CUPS (3 weeks ago)
...
- [joaompinto/janito](https://github.com/joaompinto/janito) ([v4.41.0](https://github.com/joaompinto/janito/releases/tag/v4.41.0), 3 days ago) - Minimalistic LLM Client
